        ...
        if(localStorage.getItem("userData")){
            ...
            axios.get("http://localhost:8080/finduser/"+userName,{}).then((res)=>{
                this.setState({
                    ...
                    experienceLevel : res.data[0].experienceLevel,
                    totalProjects : res.data[0].totalProjects,
                    communicationLevel : res.data[0].communicationLevel,
                    availability : res.data[0].availability,
                    mobile : res.data[0].mobile,
                    dob: res.data[0].userProfile.dob,
                    gender: res.data[0].userProfile.gender,
                    bloodGroup: res.data[0].userProfile.bloodGroup,
                    emergencyContact: res.data[0].userProfile.emergencyContact,
                    alternativeEmail: res.data[0].userProfile.alternativeEmail,
                    residentialAddress: res.data[0].userProfile.residentialAddress,
                    permenentAddress: res.data[0].userProfile.permenentAddress,
                    nationality: res.data[0].userProfile.nationality,
                    aadharNumber: res.data[0].userProfile.aadharNumber,
                    passportNumber: res.data[0].userProfile.passportNumber,
                    passportValidity: res.data[0].userProfile.passportValidity,
                    drivingLicenceNumber: res.data[0].userProfile.drivingLicenceNumber,
                    drivingLicenceValidity: res.data[0].userProfile.drivingLicenceValidity,
                    imageUrl: res.data[0].userProfile.imageUrl
                });
            }).catch((error)=>{
                $.alert({
                    title: 'Error !',
